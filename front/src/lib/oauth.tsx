...
import {
    ...
    ensureAccessToken, refreshWithOAuth, revokeTokens,
...
const REDIRECT_URI =
    import.meta.env.VITE_OAUTH_REDIRECT_URI ?? "http://localhost:5173/callback";
...
export {
    Token, ensureAccessToken, refreshWithOAuth as refreshWithDoorkeeper,
    revokeTokens, setRememberMe, getRememberMe,
};
